...
model = mlp(450,500,300) 
cr = nn.MSELoss() 
model = model_train(model,cr,n_epochs=300,l_rate=0.5) 
...
print('Confusion matrix on training data :\n',confusion_matrix(trainLabel,preds_train.cpu().numpy()))

print('Confusion matrix on testing data :\n',confusion_matrix(testLabel,preds_.cpu().numpy()))
