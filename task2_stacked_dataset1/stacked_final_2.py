# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 18:47:47 2019
...
net_joined.add_module('classifier', nn.Sequential(nn.Linear(100, 5),nn.LogSoftmax()))
print(net_joined)
