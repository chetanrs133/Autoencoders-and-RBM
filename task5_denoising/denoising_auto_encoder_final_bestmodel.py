...
#aann3
net3 = autoencoder(220,120,95)
print(net3)

if use_gpu:
    net3 = net3.float().cuda()
else:
    net3 = net3.float()
init_weightsE = copy.deepcopy(net3.encoder[0].weight.data)
init_weightsD = copy.deepcopy(net3.decoder[0].weight.data)
...
new_classifier4 = nn.Sequential(*list(net3.children())[1])
...
imgdisp(torchvision.utils.make_grid(Img), 'Noisy Input                                              Denoised Output','actual_vs_reconstr')